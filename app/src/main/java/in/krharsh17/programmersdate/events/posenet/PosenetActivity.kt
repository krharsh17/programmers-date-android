package `in`.krharsh17.programmersdate.events.posenet
...
import org.tensorflow.lite.examples.posenet.ConfirmationDialog
...
class PosenetActivity :
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (allPermissionsGranted(grantResults)) {
                ErrorDialog.newInstance("Please grant the camera permission")
    ...
    private fun setPaint() {
        paint.color = this@PosenetActivity.resources.getColor(R.color.colorAccent)
